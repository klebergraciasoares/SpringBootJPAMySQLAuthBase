...
public class StudentController {
	...
	public ResponseEntity<Student> createStudent(@RequestBody Student student) {
		try {
			Student _student = studentRepository
					.save(new Student(student.getName(), student.getAddress(), student.getMobile()));
	...
	@GetMapping("/students/mobile/{id}")
	public ResponseEntity<List<Student>> findByMobile(String mobile) {
		try {
